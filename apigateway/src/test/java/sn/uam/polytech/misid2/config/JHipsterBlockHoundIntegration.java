...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("sn.uam.polytech.misid2.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("sn.uam.polytech.misid2.security.DomainUserDetailsService", "createSpringSecurityUser");
